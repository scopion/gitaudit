...
PKGFLAGS := "-s -w -X 'main.APPName=$(PROJECT_NAME)' -X 'main.APPVersion=$(VERSION)'  -X 'main.Maintainer=$(Maintainer)'  -X 'main.BuildTime=$(BuildTime)' -X 'main.GitCommit=$(GitHash)' "
